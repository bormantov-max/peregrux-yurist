...
## Design direction v3 — Legal Premium

### 1. Общая идея

Сайт должен выглядеть как современный юридический премиум-сервис для перевозчиков и владельцев грузового транспорта: строгий, спокойный, дорогой, но без пафоса и без перегруза декоративными элементами.
...
- тёмные секции: `#111827` или `#172033`;
- глубокий синий графит: `#1E293B`;
- основной текст: `#0F172A`;
- вторичный текст: `#64748B`;
- светлый текст на тёмном фоне: `#E2E8F0`;
- золотистый акцент: `#F5B84B` или `#F59E0B`;
- рамки: `#E2E8F0`.

### 3. Принцип чередования секций

Не делать весь сайт тёмным. Использовать чередование:

- светлый hero;
- тёмный trust-bar;
- светлый блок expert;
- светлые карточки “Кому помогаем”;
- тёмный или графитовый блок “Штрафы”;
- светлый блок “Как работаем”;
- тёмный премиальный блок кейсов;
- контрастный FAQ;
- светлый финальный CTA.

### 4. Типографика

- крупные уверенные заголовки;
- короткие строки;
- без мелкого плохо читаемого текста;
- юридический тон: спокойно, точно, без крика;
- кнопки должны быть заметными, но не агрессивными.

### 5. Карточки и блоки

- карточки с мягкими рамками;
- умеренные тени;
- скругления 18–28px;
- аккуратные бейджи;
- не использовать лишние декоративные иконки;
- иконки допустимы только простые, через CSS или текстовые символы, без внешних библиотек.

### 6. Фото специалиста

Блок expert должен работать на доверие:

- фото в премиальной карточке;
- не делать фото фоном на весь сайт;
- рядом короткий текст о первичном анализе;
- CTA: отправить постановление / Telegram.

### 7. Кейсы

Кейсы должны выглядеть как доказательная часть:

- тёмный или контрастный блок;
- карточки с кратким результатом;
- акцент на обезличенных документах;
- ссылки на `cases.html`;
- не добавлять фейковые отзывы, фейковые счётчики и неподтверждённые гарантии.

### 8. FAQ и финальный CTA

FAQ можно делать в тёмной секции для визуального ритма.

Финальный CTA должен быть спокойным, конкретным и не обещать результат:

“Отправьте постановление — проверим сроки, сумму, основание привлечения и возможные ошибки в материалах.”
...
- фейковые отзывы;
- фейковые счётчики;
- агрессивный инфобизнес-стиль.

### 10. Технический принцип

Все будущие дизайн-изменения делать малыми шагами:

- сначала одна секция;
- потом визуальная проверка desktop/mobile;
- не ломать popup;
- не ломать ссылки;
- не ломать `cases.html`;
- не ломать SEO.
